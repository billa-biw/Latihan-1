...
<body>
    ...
    <table class="table table-hover table-striped">
        <thead>
            <tr>
            <th>NIK</th><th>NAMA PEGAWAI</th><th>ALAMAT</th>
        ...
        <tbody>
            <?php 
            include "koneksi.php";
            $qry_siswa=mysqli_query($conn,"select * from tabel_pegawai join tabel_jabatan on tabel_jabatan.id_jabatan=tabel_pegawai.id_pegawai");
            $no=0;
